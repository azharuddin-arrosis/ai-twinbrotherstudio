            ...
            <header className="border-b border-gray-100 sticky top-0 z-40 bg-white/95 backdrop-blur-sm">
                            ...
                            <form onSubmit={handleSearch} className="hidden sm:flex items-center">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="pl-8 pr-3 py-1.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 w-48 transition"
                                    />
                                </div>
                            </form>
                ...
                {menuOpen && (
                    <div className="md:hidden border-t border-gray-100 bg-white px-4 py-3 space-y-1">
                        ...
                        <Link href="/portfolio" className="block py-2 text-sm text-gray-700" onClick={() => setMenuOpen(false)}>
                            Portfolio
                        </Link>
                        <Link href="/hire-us" className="block py-2 text-sm font-medium text-indigo-600" onClick={() => setMenuOpen(false)}>
                            Hire Us
                        </Link>
                    </div>
                )}
